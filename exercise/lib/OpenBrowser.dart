...
class OpenBrowser extends StatefulWidget {
  const OpenBrowser({Key? key, required this.title}) : super(key: key);
  final String title;
...
class _OpenBrowserState extends State<OpenBrowser> {
  ...
  Widget build(BuildContext context) {
    ...
    // final Uri toLaunch = Uri.parse("https://www.cylog.org/headers");
    // final Uri toLaunch = Uri.parse("http://192.168.0.17:3021/page/chapter/detail/1");
    // final Uri toLaunch = Uri(scheme: 'https', host: 'www.cylog.org', path: 'headers/');
    // final Uri toLaunch = Uri(scheme: 'http', host: '192.168.0.17:3021', path: 'page/chapter/detail/1');
    final Uri toLaunch = Uri.parse("http://192.168.0.17:3021/page/chapter/detail/1");
    return Scaffold(
      appBar: AppBar(
