...
class SvgTestState extends StatefulWidget {
  const SvgTestState({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _SvgTestStateState createState() => _SvgTestStateState();
}

class _SvgTestStateState extends State<SvgTestState> {
